...
int main(int argc, char** argv)
{
    ...
    if (gb.GetPerIssueOrPR(argv[1], &list))
    {
        ...
        auto prRepo = find(((ItemsDataList*)(head->value))->begin()->begin(),
        ...
        auto prUrl = find(((ItemsDataList*)(prRepo->value))->begin()->begin(),
        ...
        if (!op.AddRemote("https://github.com/microsoft/vcpkg.git", remoteofficial, remotePR))
        {
            return 1;
        }
